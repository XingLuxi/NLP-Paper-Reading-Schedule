...
| 04.15 | 孙雅静 | [Non autoregressive neural machine translation](https://arxiv.org/pdf/1711.02281.pdf) <br>[Deterministic Non autoregressive neural sequence modeling by iterative refinement](https://arxiv.org/pdf/1802.06901.pdf) | ICLR,2018 <br> arXiv:1802.06901|
...
| 06.30 | 魏相鹏 | [Deep Reinforcement Learning for Sequence to Sequence Models](https://arxiv.org/pdf/1805.09461) | arXiv:1805.09461 |
...
| 08.12 | 谢玉强 | MRC 模型介绍 |  |
| 08.12 | 彭  伟 | [Learned in Translation: Contextualized Word Vectors](http://papers.nips.cc/paper/7209-learned-in-translation-contextualized-word-vectors) | NIPS,2017 |
| 08.20 | 邢璐茜 | MRC: J-Net Exploring Question understanding & Adaptation in NN-based QA |  |
| 08.20 | 魏相鹏 | VAE与NMT<br>[Variational Neural Machine Translation](https://arxiv.org/abs/1605.07869) | EMNLP,2016 |
| 08.20 | 孙雅静 | 对话系统: Safe response<br>1. [Neural Response Generation via GAN with an Approxiamte Embedding Layer](http://aclweb.org/anthology/D17-1065)<br>2. [Generating Informative Responses with Controlled Sentence Function](http://www.aclweb.org/anthology/P18-1139) | ACL,2018 |
...
| 09.14 | 魏相鹏 | 文档级神经机器翻译<br>[Document-Level Neural Machine Translation with Hierachical Attention Networks](https://arxiv.org/abs/1809.01576)| EMNLP,2018 |
| 09.14 | 谢玉强 | [Match-LSTM](https://arxiv.org/pdf/1608.07905.pdf) | ICLR,2017 |
| 09.14 | 孙雅静 | 文本改写<br>[Generating Sentences by Editing Prototypes](http://aclweb.org/anthology/Q18-1031)  | TACL,2018 |
| 09.22 | 邢璐茜 | CopyNet<br>1. [Pointer Network](https://papers.nips.cc/paper/5866-pointer-networks.pdf)<br>2. [Incorporating Copying mechanism in Sequence-to-Sequence](http://aclweb.org/anthology/P16-1154)<br>3. [Get to The Point: Summarization with Pointer-Generator Networks](https://arxiv.org/abs/1704.04368) | 1. NIPS,2015 <br>2. ACL,2016<br>3. arXiv:1704.04368 |
| 09.22 | 魏相鹏 | [Dynamic Sentence Sampling for Efficient Training of NMT](http://aclweb.org/anthology/P18-2048) | ACL,2018 |
| 09.22 | 雷扬帆 | Modeling Sentence Tutorial |  |
| 09.22 | 谢玉强 | Two Method for Training Deeper Networks<br>1. [Highway Network](https://arxiv.org/pdf/1505.00387.pdf)<br>2. [Residual Network](https://www.cv-foundation.org/openaccess/content_cvpr_2016/papers/He_Deep_Residual_Learning_CVPR_2016_paper.pdf)| 1. ICML,2015<br>2. CVPR,2016 |
| 09.22 | 孙雅静 | GAN回顾 |  |
| 09.22 | 彭  伟 | [Neural Machine Translation by Jointly Learning to Align and Translate](https://arxiv.org/pdf/1409.0473.pdf) | ICLR,2015 |
| 10.20 | 邢璐茜 | The Pre-Training Language Model<br>[BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](https://arxiv.org/pdf/1810.04805.pdf) |  |
| 10.20 | 魏相鹏 | [Machine Translation with Weakly Paired Bilingual Documents](https://openreview.net/pdf?id=ryza73R9tQ) | ICLR,2019. OpenReview |
