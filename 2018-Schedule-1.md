...
| 06.30 | 魏相鹏 | [Deep Reinforcement Learning for Sequence to Sequence Models](https://arxiv.org/pdf/1805.09461) | arXiv,2018 |
...
| 08.03 | 魏相鹏 | 1. [A Simple and Effective Approach to Coverage-Aware NMT](http://anthology.aclweb.org/attachments/P/P18/P18-2047.Notes.pdf)<br>2. [Bag-of-Words as Traget for NMT](http://www.aclweb.org/anthology/P18-2053) | ACL,2018<br>short paper |
| 08.03 | 孙雅静 | 对话系统综述 | |
...
| 09.22 | 邢璐茜 | CopyNet<br>1. [Pointer Network](https://papers.nips.cc/paper/5866-pointer-networks.pdf)<br>2. [Incorporating Copying mechanism in Sequence-to-Sequence](http://aclweb.org/anthology/P16-1154)<br>3. [Get to The Point: Summarization with Pointer-Generator Networks](https://arxiv.org/abs/1704.04368) | NIPS,2015 <br>ACL,2016<br>arXiv,2017 |
...
| 09.22 | 谢玉强 | Two Methods for Training Deeper Networks<br>1. [Highway Network](https://arxiv.org/pdf/1505.00387.pdf)<br>2. [Residual Network](https://www.cv-foundation.org/openaccess/content_cvpr_2016/papers/He_Deep_Residual_Learning_CVPR_2016_paper.pdf) | ICML,2015<br>CVPR,2016 |
| 09.22 | 孙雅静 | GAN回顾 |  |
...
| 10.20 | 邢璐茜 | The Pre-Training Language Model<br>1. [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](https://arxiv.org/pdf/1810.04805.pdf) | arXiv,2018 |
